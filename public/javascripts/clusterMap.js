...
map.on("load", () => {
  ...
  map.on("click", "unclustered-point", (e) => {
    ...
    // const { popUpMarkup } = e.features.properties;
    //   const coordinates = e.features.geometry[0].coordinates.slice();
    ...
    new mapboxgl.Popup()
      ...
      // .setHTML(popUpMarkup)
      .setHTML(`<a href="/campgrounds/${e.features[0].id}"> Campground</a>`)
      .addTo(map);
  });
